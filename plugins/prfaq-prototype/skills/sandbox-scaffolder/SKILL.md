...
```json
{
  ...
  "properties": {
    ...
    "options": { "type": "array", "items": { "type": "object", "properties": { "id": {"type":"string"}, "label": {"type":"string"}, "philosophy": {"type":"string"} } }, "description": "The design directions (e.g. option-a, option-b)." },
    "scenes": { "type": "array", "items": { "type": "object", "properties": { "id": {"type":"string"}, "label": {"type":"string"} } }, "description": "The screens to build (e.g. blocked-view / authoring / registry)." }
  },
